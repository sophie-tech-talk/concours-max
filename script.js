...
likeButton.addEventListener("click", () => {
  ...
  if (icon.classList.contains("fa-regular")) {
    icon.classList.replace("fa-regular", "fa-solid"); // Remplacer fa-regular par fa-solid (coeur plein)
    icon.classList.add("red-heart"); // Ajouter la couleur rouge
  } else {
    icon.classList.replace("fa-solid", "fa-regular"); // Remplacer fa-solid par fa-regular (coeur vide)
